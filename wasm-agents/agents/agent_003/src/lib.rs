/// WASM Agent 003 — DataIngestion capability
...
pub extern "C" fn agent_execute(input_ptr: *const u8, input_len: u32,
    ...
    let msg = format!("{{\"agent\":\"003\",\"capability\":\"DataIngestion\",\"inputBytes\":{},\"checksum\":{}}}", input.len(), checksum);
