/// WASM Agent 008 — Orchestration capability
...
pub extern "C" fn agent_execute(input_ptr: *const u8, input_len: u32,
    ...
    let msg = format!("{{\"agent\":\"008\",\"capability\":\"Orchestration\",\"inputBytes\":{},\"checksum\":{}}}", input.len(), checksum);
